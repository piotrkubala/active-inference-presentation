...
\frame{Posterior Belief Updating}
\frame{Policy Evaluation and Selection}
\frame{Simulated Agent Setup}
\frame{Exploring Agent Dynamics}

% Factor Graphs and Implementation
\section{Factor Graphs and Implementation}
\frame{Why Factor Graphs?}
\frame{Structure and Semantics}
\frame{Message Passing Algorithms}
\frame{Software and Computational Frameworks}
...
\frame{Recap: Core Ideas}
\frame{What Active Inference Explains}
\frame{Future Directions and Open Questions}
\frame{Questions and Discussion}
